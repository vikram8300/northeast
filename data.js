...
const MARKETS = [
    ...
    // ---- BDC-IDENTIFIED OVERLAP ZONES (FCC BDC Jun 2025 cross-reference) ----
    { lat: 41.56, lng: -72.65, name: "Middlesex County, CT (BDC Overlap)", provider: "gonet", passings: "BDC: GNS + VZ/Frontier overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows both GoNetSpeed and Verizon/Frontier filing FTTP in this county.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 8, overlapWith: ["frontier","verizon"] },
    { lat: 41.38, lng: -72.11, name: "New London County, CT (BDC Overlap)", provider: "gonet", passings: "BDC: GNS + VZ/Frontier overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows both GoNetSpeed and Verizon/Frontier filing FTTP.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 8, overlapWith: ["frontier","verizon"] },
    { lat: 43.35, lng: -70.47, name: "York County, ME (BDC Overlap)", provider: "gonet", passings: "BDC: GNS + Fidium overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows both GoNetSpeed and Fidium filing FTTP in York County.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 8, overlapWith: ["fidium"] },
    { lat: 43.84, lng: -69.94, name: "Sagadahoc/Lincoln, ME (BDC Overlap)", provider: "gonet", passings: "BDC: GNS + Fidium overlap", status: "BDC Overlap Zone", notes: "FCC BDC cross-reference: both providers claim FTTP coverage.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 6, overlapWith: ["fidium"] },
    { lat: 44.10, lng: -70.21, name: "Androscoggin County, ME (BDC Overlap)", provider: "fidium", passings: "BDC: Fidium + GNS overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows both Fidium and GoNetSpeed filing FTTP.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 7, overlapWith: ["gonet"] },
    { lat: 42.89, lng: -78.88, name: "Erie County, NY (BDC Overlap)", provider: "gonet", passings: "BDC: GNS + VZ overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows GoNetSpeed and Verizon both filing FTTP in Erie County.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 8, overlapWith: ["verizon"] },
    { lat: 43.64, lng: -72.87, name: "Rutland County, VT (BDC Overlap)", provider: "fidium", passings: "BDC: Fidium + GNS overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows both Fidium and GoNetSpeed filing FTTP.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 6, overlapWith: ["gonet"] },
    { lat: 43.38, lng: -72.34, name: "Windsor County, VT (BDC Overlap)", provider: "fidium", passings: "BDC: Fidium + GNS overlap", status: "BDC Overlap Zone", notes: "Upper Valley area. Fidium expansion overlaps with GoNetSpeed VT presence.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 6, overlapWith: ["gonet"] },
    { lat: 42.37, lng: -71.06, name: "Suffolk County, MA (BDC Overlap)", provider: "verizon", passings: "BDC: VZ + Fidium overlap", status: "BDC Overlap Zone", notes: "FCC BDC shows Verizon and Fidium both filing FTTP in the Boston metro.", source: "FCC BDC Jun 2025", sourceUrl: "https://broadbandmap.fcc.gov/data-download/fixed", size: 10, overlapWith: ["fidium"] },
];
